...
<div class="modal fade" id="ModalAgregar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<?= form_open('citas/agregar', array('id' => 'citasForm')) ?>
			...
			<div class="modal-body bg-info">
				<div class="row">
					...
					<div class="alert alert-success" id="success">
						<strong><span class="glyphicon glyphicon-ok-sign"></span> ¡Excelente!</strong> La cita médica ha sido agregada con éxito
					</div>
				...
				<div class="row">
					<div class="col-xs-6">
						<?= form_label('Medico Tratante', 'medico') ?>
					</div>
					<div class="col-xs-6">
						<?= form_dropdown('medico', $medicos, '', array('id' => 'medico')) ?>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6">
						<?= form_label('Paciente', 'paciente') ?>
					</div>
					<div class="col-xs-6">
						<?= form_dropdown('paciente', $pacientes, '', array('id' => 'paciente')) ?>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6">
					...
					<div class="col-xs-6">
						<?= form_input(array('type' => 'date', 'name' => 'fecha', 'id' => 'fecha', 'placeholder' => 'Formato: Año-Mes-Dia')) ?>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6">
					...
					<div class="col-xs-6">
						<?= form_dropdown('turno', $turnos, '', array('id' => 'turno')) ?>
					</div>
				</div>
			</div>
...
<script>
	$(function(){
		...
		$("#citasForm").submit(function(){
			var formData = new FormData(document.getElementById("citasForm"));
            $.ajax({
                url: "<?= base_url() ?>citas/agregar",
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
